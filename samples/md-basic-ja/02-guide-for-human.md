...
| ファイル | バイト | `.md` 一式 (214,545 バイト) 比 |
|---|---:|---:|
| `index.json` (そのまま) | 523,053 | 2.44 |
| `jq .` を通したもの | 326,660 | 1.52 |
| `jq -c .` を通したもの | 259,431 | 1.21 |
...
2. `03-architecture.md` から `07-tests.md` までの中身を自分のものへ差し替える。
