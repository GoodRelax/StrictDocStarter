...
> serve-spec.md v1.1 (公式委譲 & 可視ウィンドウ方式) と対になる setup 側の改訂。 根拠: 内部設計ノート (`improvement-items.md`、 非収録) の D-4/D-5, S-3, S-4, O-1/O-2/O-5。
